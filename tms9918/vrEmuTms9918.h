...
void __time_critical_func(vrEmuTms9918WriteAddr)(VrEmuTms9918* tms9918, uint8_t data);
...
void __time_critical_func(vrEmuTms9918WriteData)(VrEmuTms9918* tms9918, uint8_t data);
...
void __time_critical_func(vrEmuTms9918ScanLine)(VrEmuTms9918* tms9918, uint8_t y, uint8_t pixels[TMS9918_PIXELS_X]);
